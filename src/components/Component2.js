...
const GraphComponent = () => {
  return (
    <div className="graph-component">
      <p className="heading-medium">Contributions Overtime</p>
      <Graph />
    </div>
  );
};
      ...
      <div className="peers-comparison-stats">
        <div className="comparison-settings">
          <div className="comparison-setting">
            <label className="text-medium bolder" htmlFor="age-input">
              Age:
            </label>
            <select
          ...
          <div className="comparison-setting">
            <label className="text-medium bolder" htmlFor="salary-input">
              Salary:
            </label>
            <select
              defaultValue={"K 20 -  K 30"}
              className="text-medium"
              name="salary-input"
              id="salary-input"
            >
          ...
          <div className="comparison-setting">
            <label className="text-medium bolder" htmlFor="gender-input">
              Gender:
            </label>
            <select
              defaultValue={"Male"}
        ...
        <div className="comparison-donuts">
          <div className="comparison-donut">
            <Donut name={"Average"} percentage={78} />
            <p className="text-medium">Average</p>
          </div>
          <div className="comparison-donut">
            <Donut name={"Top"} percentage={95} />
            <p className="text-medium">Top</p>
          </div>
          <div className="comparison-donut">
            <Donut name={"Me"} percentage={59} />
